    ...
    try {
      ...
      data.forEach((item) => {
        ...
        itemElement.innerHTML = `
          <div class="row g-0">
              <div class="col-md-4">
                  <img src="/uploads/${item.gambar}" class="img-fluid" alt="${item.nama_isu}">
              </div>
              <div class="col-md-8">
                  <div class="card-body">
                      ...
                      <div class="card-buttons">
                          <a href="/#/edit-form-edukasi/${item.id}">
                              <button class="btn btn-edit rounded-circle me-2">
                                  <i class="fas fa-edit"></i>
                              </button>
                          </a>
                          <button class="btn btn-hapus rounded-circle" data-id="${item.id}">
